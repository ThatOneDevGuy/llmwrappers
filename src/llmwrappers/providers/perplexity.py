...
from ..wrapper_utils import clean_json_string


class PerplexityWrapper(ChatWrapper):
    """
    An asynchronous implementation of ChatWrapper for interacting with Perplexity AI models.
    ...
    def __init__(self, model: str, **kwargs):
        """
        Initialize the PerplexityWrapper.
